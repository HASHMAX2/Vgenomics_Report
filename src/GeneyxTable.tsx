...
//     const doc = new jsPDF();
//     doc.text("Selected Rows Report", 14, 10);

//     // Get column headers
//     const headers = table.getAllColumns().map((col) => col.id);

//     // Get selected row data
//     const rows = Array.from(selectedRows).map((rowId) => {
...
//                 <td className="border border-gray-200 px-2 w-10 text-center">
//                   <input
//                     type="checkbox"
...
//                   <td
//                     key={cell.id}
//                     className="border border-gray-200 max-w-fit px-4 py-2 text-center text-xs"
//                   >
...
//---------------------------------------------------------------------------------------------------//
//code 2 with upodated but incomplete report
...
//     const doc = new jsPDF();
//     doc.setFontSize(16);
//     doc.text("Whole Exome Sequencing Report", 14, 15);

//     doc.setFontSize(12);
//     doc.text("Patient Information", 14, 25);
//     doc.text("Name: XXXX", 14, 35);
//     doc.text("Age/DOB: XXXX", 14, 45);
//     doc.text("Gender: XXXX", 14, 55);
//     doc.text("Specimen Type: Blood", 14, 65);

//     doc.text("Clinical Phenotype", 14, 75);
//     doc.setFontSize(10);
//     doc.text(
...
//     doc.setFontSize(12);
//     doc.text("Variant Details", 14, 95);
//     let finalY = 100;
